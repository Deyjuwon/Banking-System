...
var user2 = new Account("NewBank", "Gabriel Mayowa", 10000, "0226660175");
...
var updateUI = function () {
    if (document) {
        ...
        userOneAccountBalance.innerText = "Balance: ".concat(currencyUtility(user1.getBalance()));
        userOneAccountNumber.innerText = "Account Number: ".concat(user1.getAccountNumber());
