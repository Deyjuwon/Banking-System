...
const user2 = new Account("NewBank", "Gabriel Mayowa", 10000, "0226660175")
...
const updateUI = () => {
  ...
  if(document){
    ...
    userOneAccountBalance.innerText = `Balance: ${currencyUtility(user1.getBalance())}`;
    userOneAccountNumber.innerText = `Account Number: ${user1.getAccountNumber()}`;
